            ...
            return ListView(
              ...
              children: <Widget>[
                ...
                ListTile(
                  ...
                  title: Text('${getDateText(event.dateTime)}', style: NORMAL),
                  minLeadingWidth: 10.0,
                ),
                ListTile(
                  visualDensity: VisualDensity(horizontal: 0, vertical: -4),
                  leading: Icon(Icons.access_time, size: 15),
                  title: Text('${getTimeText(event.dateTime)}', style: NORMAL),
                  minLeadingWidth: 10.0,
                ),
                ListTile(
                  visualDensity: VisualDensity(horizontal: 0, vertical: -4),
                ...
                ListTile(
                  ...
                  title: Text(event.location, style: NORMAL),
                  minLeadingWidth: 10.0,
                ),
                ListTile(
                  visualDensity: VisualDensity(horizontal: 0, vertical: -4),
                  leading: Icon(Icons.person_pin_circle_rounded, size: 15),
                  title: Text(_initiator, style: NORMAL),
                  minLeadingWidth: 10.0,
                ),
                Row(
                  children: <Widget>[
                                      ...
                                      onPressed: () async {
                                        return showDialog(
                                          ...
                                          builder: (context) => AlertDialog(
                                            ...
                                            content: Text(
                                                'Event is full! Try other events.'),
                                            actions: <Widget>[
                                              TextButton(
                                                onPressed: () {
                                                  Navigator.of(context).pop();
