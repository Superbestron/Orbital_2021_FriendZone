...
class _NotificationTileState extends State<NotificationTile> {
  ...
  void getNotification() async {
    notification = await DatabaseService(uid: widget.uid).getNotificationObj(widget.notificationID);
    setState(() {
      initialised = true;
    });
  }
      ...
      child: Card(
        ...
        child: ListTile(
          ...
          title: Padding(
            ...
            child: Text("notification name", style: TextStyle(fontSize: 18)),
          ),
          subtitle: Text("notification subtitle", style: TextStyle(fontSize: 18)),
